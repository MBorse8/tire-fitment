...
// Action constants
export const LOAD_TYRES = "[Fitment] Load tyres";
export const LOAD_TYRES_FAIL = "[Fitment] Load tyres Fail";
export const LOAD_TYRES_SUCCESS = "[Fitment] Load tyres Success";
